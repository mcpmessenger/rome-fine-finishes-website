...
const getGalleryImages = (category: GalleryCategory, limit = 6, offset = 0) => {
...
const services: ServiceSection[] = [
  ...
  },
  {
    ...
    description:
      "Want to go further than a fresh coat of paint? Cabinet refacing replaces your existing door and drawer faces with brand-new ones — giving your kitchen or bathroom a completely custom look without the cost of a full remodel. This option is perfect for spaces with \"good bones\" or clients looking to add cabinets and maximize functionality. Pair it with refinishing for a total transformation. Get started today with a free estimate.",
    imageAlt: "Cabinet refacing project",
    cta: "Schedule an Estimate",
    ctaLink: "https://romefinefinishes.dripjobs.com",
    imagePosition: "right",
    images: getGalleryImages("cabinetry", 8, 8),
    autoplayDelay: 7500,
    autoplayOffset: 1500,
  },
  {
